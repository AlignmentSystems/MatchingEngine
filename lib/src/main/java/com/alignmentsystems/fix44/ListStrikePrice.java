...
public class ListStrikePrice extends Message {
	...
	public ListStrikePrice(com.alignmentsystems.fix44.field.ListID listID, com.alignmentsystems.fix44.field.TotNoStrikes totNoStrikes) {
		this();
		setField(listID);
	...
	public void set(com.alignmentsystems.fix44.field.TotNoStrikes value) {
		setField(value);
	}

	public com.alignmentsystems.fix44.field.TotNoStrikes get(com.alignmentsystems.fix44.field.TotNoStrikes value) throws FieldNotFound {
		getField(value);
		return value;
	}

	public com.alignmentsystems.fix44.field.TotNoStrikes getTotNoStrikes() throws FieldNotFound {
		return get(new com.alignmentsystems.fix44.field.TotNoStrikes());
	}

	public boolean isSet(com.alignmentsystems.fix44.field.TotNoStrikes field) {
		return isSetField(field);
	}
	...
	public void set(com.alignmentsystems.fix44.field.NoStrikes value) {
		setField(value);
	}

	public com.alignmentsystems.fix44.field.NoStrikes get(com.alignmentsystems.fix44.field.NoStrikes value) throws FieldNotFound {
		getField(value);
		return value;
	}

	public com.alignmentsystems.fix44.field.NoStrikes getNoStrikes() throws FieldNotFound {
		return get(new com.alignmentsystems.fix44.field.NoStrikes());
	}

	public boolean isSet(com.alignmentsystems.fix44.field.NoStrikes field) {
		return isSetField(field);
	}
