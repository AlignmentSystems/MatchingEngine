...
public class RequestForPositions extends Message {
	...
	public RequestForPositions(com.alignmentsystems.fix44.field.PosReqID posReqID, com.alignmentsystems.fix44.field.PosReqType posReqType, com.alignmentsystems.fix44.field.Account account, com.alignmentsystems.fix44.field.AccountType accountType, com.alignmentsystems.fix44.field.ClearingBusinessDate clearingBusinessDate, com.alignmentsystems.fix44.field.TransactTime transactTime) {
		this();
		setField(posReqID);
		setField(posReqType);
		setField(account);
