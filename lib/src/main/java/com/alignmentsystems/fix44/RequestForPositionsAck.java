...
public class RequestForPositionsAck extends Message {
	...
	public RequestForPositionsAck(com.alignmentsystems.fix44.field.PosMaintRptID posMaintRptID, com.alignmentsystems.fix44.field.PosReqResult posReqResult, com.alignmentsystems.fix44.field.PosReqStatus posReqStatus, com.alignmentsystems.fix44.field.Account account, com.alignmentsystems.fix44.field.AccountType accountType) {
		this();
	...
	public void set(com.alignmentsystems.fix44.field.PosReqStatus value) {
		setField(value);
	}

	public com.alignmentsystems.fix44.field.PosReqStatus get(com.alignmentsystems.fix44.field.PosReqStatus value) throws FieldNotFound {
		getField(value);
		return value;
	}

	public com.alignmentsystems.fix44.field.PosReqStatus getPosReqStatus() throws FieldNotFound {
		return get(new com.alignmentsystems.fix44.field.PosReqStatus());
	}

	public boolean isSet(com.alignmentsystems.fix44.field.PosReqStatus field) {
		return isSetField(field);
	}
