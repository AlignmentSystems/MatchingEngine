...
public class CollateralAssignment extends Message {
	...
	public CollateralAssignment(com.alignmentsystems.fix44.field.CollAsgnID collAsgnID, com.alignmentsystems.fix44.field.CollAsgnReason collAsgnReason, com.alignmentsystems.fix44.field.CollAsgnTransType collAsgnTransType, com.alignmentsystems.fix44.field.TransactTime transactTime) {
		this();
		setField(collAsgnID);
	...
	public void set(com.alignmentsystems.fix44.field.CollAsgnRefID value) {
		setField(value);
	}

	public com.alignmentsystems.fix44.field.CollAsgnRefID get(com.alignmentsystems.fix44.field.CollAsgnRefID value) throws FieldNotFound {
		getField(value);
		return value;
	}

	public com.alignmentsystems.fix44.field.CollAsgnRefID getCollAsgnRefID() throws FieldNotFound {
		return get(new com.alignmentsystems.fix44.field.CollAsgnRefID());
	}

	public boolean isSet(com.alignmentsystems.fix44.field.CollAsgnRefID field) {
		return isSetField(field);
	}
