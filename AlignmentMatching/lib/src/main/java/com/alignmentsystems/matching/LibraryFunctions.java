...
class LibraryFunctions {
	...
	protected static OrderBookSide getOrderBookSide(InterfaceOrder nos) {
	 ...
	 */
	protected static String wrapNameSquareBrackets(String wrapName) {
	...
	protected static String wrapNameSquareBracketsAndSpaces(String wrapName) {
		return new StringBuilder()
