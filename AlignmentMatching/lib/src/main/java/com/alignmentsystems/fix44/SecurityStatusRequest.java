...
public class SecurityStatusRequest extends Message {
	...
	public SecurityStatusRequest(com.alignmentsystems.fix44.field.SecurityStatusReqID securityStatusReqID, com.alignmentsystems.fix44.field.SubscriptionRequestType subscriptionRequestType) {
		this();
