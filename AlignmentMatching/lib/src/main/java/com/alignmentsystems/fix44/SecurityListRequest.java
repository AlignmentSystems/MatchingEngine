...
public class SecurityListRequest extends Message {
	...
	public SecurityListRequest(com.alignmentsystems.fix44.field.SecurityReqID securityReqID, com.alignmentsystems.fix44.field.SecurityListRequestType securityListRequestType) {
		this();
