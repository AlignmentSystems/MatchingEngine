...
public class TradeCaptureReportRequest extends Message {
	...
	public TradeCaptureReportRequest(com.alignmentsystems.fix44.field.TradeRequestID tradeRequestID, com.alignmentsystems.fix44.field.TradeRequestType tradeRequestType) {
		this();
	...
	public void set(com.alignmentsystems.fix44.field.NoDates value) {
		setField(value);
	}

	public com.alignmentsystems.fix44.field.NoDates get(com.alignmentsystems.fix44.field.NoDates value) throws FieldNotFound {
		getField(value);
		return value;
	}

	public com.alignmentsystems.fix44.field.NoDates getNoDates() throws FieldNotFound {
		return get(new com.alignmentsystems.fix44.field.NoDates());
	}

	public boolean isSet(com.alignmentsystems.fix44.field.NoDates field) {
		return isSetField(field);
	}
