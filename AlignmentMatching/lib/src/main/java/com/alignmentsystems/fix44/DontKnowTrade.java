...
public class DontKnowTrade extends Message {
	...
	public DontKnowTrade(com.alignmentsystems.fix44.field.OrderID orderID, com.alignmentsystems.fix44.field.ExecID execID, com.alignmentsystems.fix44.field.DKReason dKReason, com.alignmentsystems.fix44.field.Side side) {
		this();
		setField(orderID);
		setField(execID);
		setField(dKReason);
	...
	public void set(com.alignmentsystems.fix44.field.DKReason value) {
		setField(value);
	}

	public com.alignmentsystems.fix44.field.DKReason get(com.alignmentsystems.fix44.field.DKReason value) throws FieldNotFound {
		getField(value);
		return value;
	}

	public com.alignmentsystems.fix44.field.DKReason getDKReason() throws FieldNotFound {
		return get(new com.alignmentsystems.fix44.field.DKReason());
	}

	public boolean isSet(com.alignmentsystems.fix44.field.DKReason field) {
		return isSetField(field);
	}
