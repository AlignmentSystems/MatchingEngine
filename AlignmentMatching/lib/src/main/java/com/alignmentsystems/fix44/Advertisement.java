...
public class Advertisement extends Message {
	...
	public Advertisement(com.alignmentsystems.fix44.field.AdvId advId, com.alignmentsystems.fix44.field.AdvTransType advTransType, com.alignmentsystems.fix44.field.AdvSide advSide, com.alignmentsystems.fix44.field.Quantity quantity) {
		this();
		setField(advId);
	...
	public void set(com.alignmentsystems.fix44.field.AdvId value) {
		setField(value);
	}

	public com.alignmentsystems.fix44.field.AdvId get(com.alignmentsystems.fix44.field.AdvId value) throws FieldNotFound {
		getField(value);
		return value;
	}

	public com.alignmentsystems.fix44.field.AdvId getAdvId() throws FieldNotFound {
		return get(new com.alignmentsystems.fix44.field.AdvId());
	}

	public boolean isSet(com.alignmentsystems.fix44.field.AdvId field) {
	...
	public void set(com.alignmentsystems.fix44.field.AdvTransType value) {
		setField(value);
	}

	public com.alignmentsystems.fix44.field.AdvTransType get(com.alignmentsystems.fix44.field.AdvTransType value) throws FieldNotFound {
		getField(value);
		return value;
	}

	public com.alignmentsystems.fix44.field.AdvTransType getAdvTransType() throws FieldNotFound {
		return get(new com.alignmentsystems.fix44.field.AdvTransType());
	}

	public boolean isSet(com.alignmentsystems.fix44.field.AdvTransType field) {
		return isSetField(field);
	}
	...
	public void set(com.alignmentsystems.fix44.field.AdvRefID value) {
		setField(value);
	}

	public com.alignmentsystems.fix44.field.AdvRefID get(com.alignmentsystems.fix44.field.AdvRefID value) throws FieldNotFound {
		getField(value);
		return value;
	}

	public com.alignmentsystems.fix44.field.AdvRefID getAdvRefID() throws FieldNotFound {
		return get(new com.alignmentsystems.fix44.field.AdvRefID());
	}

	public boolean isSet(com.alignmentsystems.fix44.field.AdvRefID field) {
		return isSetField(field);
	}
	...
	public void set(com.alignmentsystems.fix44.field.AdvSide value) {
		setField(value);
	}

	public com.alignmentsystems.fix44.field.AdvSide get(com.alignmentsystems.fix44.field.AdvSide value) throws FieldNotFound {
		getField(value);
		return value;
	}

	public com.alignmentsystems.fix44.field.AdvSide getAdvSide() throws FieldNotFound {
		return get(new com.alignmentsystems.fix44.field.AdvSide());
	}

	public boolean isSet(com.alignmentsystems.fix44.field.AdvSide field) {
		return isSetField(field);
	}
