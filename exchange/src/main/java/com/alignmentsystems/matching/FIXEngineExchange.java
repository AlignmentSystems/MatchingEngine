...
public class FIXEngineExchange extends MessageCracker implements quickfix.Application{
	...
	public FIXEngineExchange(LogEncapsulation log, InterfaceQueueNonSequenced queueNonSequenced, InstanceType instanceType) {
		this.log = log;
	...
	public void fromApp(Message message, SessionID sessionId)
		...
		log.infoFIXSession(message.toRawString(), sessionId, MessageDirection.RECEIVED, METHODNAME, this.CLASSNAME, instanceType);
	...
	public void onMessage(com.alignmentsystems.fix44.NewOrderSingle message, SessionID sessionID) 			  
		...
		try{
			...
			log.errorFIXSession(sb.toString(), sessionID, MessageDirection.RECEIVED, METHODNAME, message.getClass().getSimpleName(), instanceType);
		}
	}
	...
	public void onMessage(com.alignmentsystems.fix44.ExecutionReport message, SessionID sessionID) 			  
		...
		StringBuilder sb = new StringBuilder()				
				...
				.append(")") 
				;
		log.infoFIXSession(sb.toString(), sessionID, MessageDirection.RECEIVED, METHODNAME, message.getClass().getSimpleName(), this.instanceType);
